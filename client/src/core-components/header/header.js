        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-light bg-light">
                <div className="container-fluid">
                    <button type="button" id="sidebarCollapse" className="btn hamburger"></button>
                    <Link to="/dashboard" className="navbar-brand">test</Link>   
                        ...
                        <ul className="nav navbar-nav ml-auto">
                            <li className="nav-item ">
                                <div className="btn-group pull-right user-profile-dropdown">
                                    <button type="button" className="btn dropdown-toggle no-bg" data-toggle="dropdown"
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right">
                                        ...
                                        <Link to="" className="dropdown-item btn-logout" onClick={this.signOut}>Log out</Link>   
                                    </div>
                                </div>
                            </li>
                        </ul>
